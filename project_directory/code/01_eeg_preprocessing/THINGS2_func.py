def epoching(args, data_part, seed):
	...
	performs channel selection, re-reference, bandpass filter, epoching, 
	baseline correction and frequency downsampling. Then, it sorts the 
	EEG data of each session according to the image conditions.
	...
	for s in range(args.n_ses):
		...
		eeg_dir = os.path.join('eeg_dataset','wake_data','THINGS_EEG2',
						 'raw_data', 'sub-'+format(args.subj,'02'), 
